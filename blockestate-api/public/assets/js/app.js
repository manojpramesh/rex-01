$(function () {
    ...
    $(window).load(function () {
      ...
      }, 100), $('link[id="style_sheet"]').attr("href", "css/skins/default.css"), $(".logo img").attr("src", "img/logos/logo.png"), $(function () {
        $(".filtr-container").filterizr({
          delay: 1
        })
      }), $(".filters-listing-navigation li").click(function () {
        $(".filters-listing-navigation .filtr").removeClass("active"), $(this).addClass("active")
      })
    });
    var i = new WOW({
    ...
    i.init(),
      ...
      function () {
        ...
        $(".player").mb_YTPlayer()
      }), $("[data-submenu]").submenupicker(), $(".show-more-options").click(function () {
  ...
  function (a) {
    a(window).resize(function () {
      a("#map").css("height", a(this).height() - 110), a(this).width() > 768 ? (a(".map-content-sidebar").mCustomScrollbar({
        theme: "minimal-dark"
      }), a(".map-content-sidebar").css("height", a(this).height() - 110)) : (a(".map-content-sidebar").mCustomScrollbar("destroy"), a(".map-content-sidebar").css("height", "100%"))
    }).trigger("resize")
  }(jQuery);
